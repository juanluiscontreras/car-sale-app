...
import { FaCarSide, FaCogs, FaShieldAlt, FaLightbulb, FaWifi, FaLock, FaWrench, FaCheck, FaBluetooth, FaLuggageCart, FaSuitcase, FaSuitcaseRolling } from 'react-icons/fa';
...
const CarFeatures = () => {
  ...
  const features = [
    ...
    { icon: <FaCheck />, text: t('features.point1') },
    { icon: <FaCheck />, text: t('features.point2') },
